...
import '../../styles/auth/passenger-login.css';
...
const PassengerLogin = () => {
  ...
  useEffect(() => {
    ...
    } else if (user && user.userType === 'DRIVER') {
      // If logged in as driver, redirect to driver dashboard
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const data = await loginUser(email, password, 'passenger');
  ...
  return (
    <>
      ...
      <div className="auth-container passenger-auth">
        ...
        <p className="switch-role">
          Are you a driver? <Link to="/login/driver">Driver Login</Link>
        </p>
      </div>
    </div>
    </>
